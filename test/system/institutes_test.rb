...
class InstitutesTest < ApplicationSystemTestCase
  ...
  test "creating a Institute" do
    ...
    fill_in "Active", with: @institute.active
    fill_in "Description", with: @institute.description
    fill_in "Is Demo", with: @institute.is_demo
    fill_in "Location", with: @institute.location
    fill_in "Location", with: @institute.location_id
    fill_in "Name", with: @institute.name
    fill_in "Status", with: @institute.status
